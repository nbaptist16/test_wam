...
// from: https://github.com/suprbot/7Dof_Robot_Controller/blob/master/7Dof_Elmo_Xenomai/src/kine.cpp
...
//DH parameters
// see: https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.1039.542&rep=rep1&type=pdf?
//      https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=8630999
...
const double Dbs = 0.55;    // @3
const double Dse = 0.3;     // @5
const double Dew = 0.0609;  // @7
const double Dwt = 0.10;    // @T (8-ish)
...
const double theta1_u = 2.6;
const double theta1_l = -2.6;
const double theta2_u = 2.0;
const double theta2_l = -2.0;
const double theta3_u = 2.8;
const double theta3_l = -2.8;
const double theta4_u = 3.1;
const double theta4_l = -0.9;
const double theta5_u = 1.3;
const double theta5_l = -4.8;
const double theta6_u = 1.6;
const double theta6_l = -1.6;
const double theta7_u = 2.2;
const double theta7_l = -2.2;
